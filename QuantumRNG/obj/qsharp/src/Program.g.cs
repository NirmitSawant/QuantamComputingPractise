...
#line hidden
            {
#line 9 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 10 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 11 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs", OperationFunctor.Body, 14, 27)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 15 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 16 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 17 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 18 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 19 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 21 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
...
#line 23 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs", OperationFunctor.Body, 27, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 28 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
            var max = 50L;
#line 29 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between 0 and {0}: ", max));
#line 30 "C:\\Users\\sawan\\VSCode\\Quantam\\QuantumRNG\\Program.qs"
